...
const CORRUPT_TILES: Array[Vector2i] = [Vector2i(7,26), Vector2i(7,27)] ## 紫色腐化植被
const POND_RECT: Rect2i = Rect2i(24, 16, 9, 6)
...
@export var map_size: Vector2i = Vector2i(60, 44)
...
func _decorate() -> void:
	for i in 100:
		...
		if POND_RECT.grow(1).has_point(cell):
			continue
		decor.set_cell(cell, 0, CORRUPT_TILES.pick_random())
